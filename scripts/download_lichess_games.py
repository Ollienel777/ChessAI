# scripts/download_lichess_games.py
import argparse
import json
...
def download_games(username: str,
                   ...
                   min_elo: int = 2200):
    """
    Downloads rated games for `username` from Lichess API,
    keeps only games where both players have rating >= min_elo,
    and saves PGN text to out_path.
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("username", help="Lichess username to download games from")
